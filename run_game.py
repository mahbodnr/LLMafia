...
def main():
    ...
    parser.add_argument('--save-transcript', type=bool, default=True, help='Save game transcript')
    ...
    config["logging"]["save_transcripts"] = args.save_transcript
    ...
    try:
        ...
        # Print transcript location if saved
        if args.save_transcript:
            transcript_dir = config["logging"]["transcript_dir"]
            print(f"Game transcript saved to {transcript_dir}/")
